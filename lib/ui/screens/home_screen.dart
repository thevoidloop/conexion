...
List<Widget> _buildDrawerItems(BuildContext context) {
  List<Widget> items = [
    const DrawerHeader(
      ...
      child: Center(child: Text('EMPRESA S.A.', style: TextStyle(color: Colors.white, fontSize: 24))),
    ),
  ];

  List<Option> drawerItems = Provider.of<DatabaseManagerProvider>(context, listen: false).options;
